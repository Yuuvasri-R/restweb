...
<header class="site-header">
  <div class="logo">
    <img src="title.png" alt="Sweet and Spicy">
    <h1>Sweet and Spicy </h1>
  </div>
</header>
...
<footer class="site-footer">
  <div class="footer-left">Designed by <strong>YUUVASRI R</strong></div>
  <div class="footer-right">2025 Sweet and Spicy</div>
</footer>
...
<section class="contact-section">
  ...
  <p><strong>Phone:</strong> +1 (555) 345-2567</p>
  <p><strong>Email:</strong> contact@sweetandspicy.com</p>
</section>
...
<div class="main-gallery">
  ...
  <div class="menu-item"><img src="pizza.jpg"><h3>Pizza</h3><p>$10.00</p></div>
  <div class="menu-item"><img src="pasta.jpg"><h3>Pasta</h3><p>$8.00</p></div>
  <div class="menu-item"><img src="salad.jpg"><h3>Salad</h3><p>$6.00</p></div>
  <div class="menu-item"><img src="fries.jpg"><h3>Fries</h3><p>$3.00</p></div>
  <div class="menu-item"><img src="sandwich.jpg"><h3>Sandwich</h3><p>$4.50</p></div>
  <div class="menu-item"><img src="icecream.jpg"><h3>Ice Cream</h3><p>$2.50</p></div>
  <div class="menu-item"><img src="milkshake.jpg"><h3>Milkshake</h3><p>$3.50</p></div>
</div>
</div>
<footer class="site-footer">
  <div class="footer-left">Designed by <strong>YUUVASRI R</strong></div>
...
## OUTPUT:
![alt text](<pearl/softapp/static/Screenshot (32).png>)
![alt text](<pearl/softapp/static/Screenshot (27).png>)
![alt text](<pearl/softapp/static/Screenshot (28).png>)
![alt text](<pearl/softapp/static/Screenshot (30).png>)
![alt text](<pearl/softapp/static/Screenshot (33).png>)
![alt text](<pearl/softapp/static/Screenshot (34).png>)
